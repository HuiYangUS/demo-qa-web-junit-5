...
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "cucumber.hooks.browsers.edge, cucumber.hooks.test, cucumber.hooks.config, cucumber.step_definitions.demo")
